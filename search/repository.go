...
type Repository interface {
	...
	SearchMeows(ctx contex.Contex, query string, skip uint64, take uint64) ([]schema.Meow, error)
}
...
func SearchMeows(ctx contex.Contex, query string, skip uint64, take uint64) ([]schema.Meow, error) {
